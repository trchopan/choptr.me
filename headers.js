...
export const title = "Chop Tr";
export const description = "Hi, My name is Chop. I code. I run. I meditate";
export const locale = "en_US";
export const url = "https://choptr.me";
...
export const meta = [
  ...
  { name: "copyright", content: `Copyright (c) 2018-${currentYear} Chop Tr` },
...
export const link = [
  {
    rel: "stylesheet",
    href: "https://fonts.googleapis.com/css?family=Fira+Code|Play:300,400,500,700"
  },
  {
    rel: "manifest",
